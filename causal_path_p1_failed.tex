...
% 1
\node[draw,align=center,text=black] (ArgumentA1) at (1,0) {Strong\\industrial sector};
\node[draw,align=center,text=black] (ArgumentB1) at (4.5,0) {Low\\sectoral inequality};
\node[draw,align=center,,text=black] (ArgumentC) at (8,0) {Credible\\sectoral threat};
\node[draw,align=center,fill=yellow,text=black] (ArgumentD1) at (11.5,0) {\underline{Income Tax}\\{\bf Early}\\implementation};
\node[draw,align=center,text=black] (ArgumentD3) at (8,-2) {Successful incorporation\\of both elites};
...
% 2
\node[draw,align=center,text=black, fill=red] (ArgumentA2) at (1,2) {Weak\\industrial sector};
\node[draw,align=center,text=black, fill=red] (ArgumentB2) at (4.5,2) {High\\sectoral inequality};
\node[draw,align=center,fill=red] (ArgumentC) at (8,2) {Non-credible\\sectoral threat};
\node[draw,,align=center,fill=yellow,text=black] (ArgumentD2) at (11.5,2) {\underline{Income Tax}\\{\bf Delayed}\\implementation};
\node[draw,align=center,fill=red] (ArgumentD23) at (8,4) {Failure to incorporate\\both elites};
