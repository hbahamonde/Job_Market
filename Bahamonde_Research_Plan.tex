...
\begin{enumerate}
  ...
  % Mart paper
  \item ``\href{https://github.com/hbahamonde/Inequality_State_Capacities/raw/master/Paper_EJPE_Under_Review.pdf}{{\input{/Users/hectorbahamonde/research/Inequality_State_Capacities/title.txt}\unskip}}.'' {\bf This paper's status is {\input{/Users/hectorbahamonde/research/Inequality_State_Capacities/status.txt}\unskip} and it looks at the relationship between inequality, democracy and state capacity}. {\input{/Users/hectorbahamonde/research/Inequality_State_Capacities/abstract.txt}\unskip}

  % Igor paper
  \item ``\href{https://github.com/hbahamonde/Bahamonde_Kovac/raw/master/Bahamonde_Kovac.pdf}{{\input{/Users/hectorbahamonde/research/Bahamonde_Kovac/title.txt}\unskip}}.'' {\bf This paper was just presented at the APSA 2020 conference, and it seeks to identify (using time-series methods) if economic power Granger-causes military power or \emph{vice versa}}. {\input{/Users/hectorbahamonde/research/Bahamonde_Kovac/abstract.txt}\unskip}
