\begin{enumerate}
  ...
  \item {\bf University of Turku}:
      ...
      \item[\textcolor{gray}{\textbullet}] \href{https://github.com/hbahamonde/Exp_Soc_Science/raw/main/Bahamonde_Exp_Soc_Sci.pdf}{``Experimental Social Science''}: {\color{gray}MA and PhD in `Inequalities, Interventions and New Welfare State.'}
    \end{itemize}
