...
\begin{itemize}
  \item Ph.D. Political Science, Rutgers, The State University of New Jersey - New Brunswick
 (2017, expected).

    	\begin{itemize}

		\item[$\bullet$] Dissertation: ``State Capacities in Latin America: Structural Transformations, Elite Competition, and Fiscal Development (1850-2010).''

		\item[$\bullet$] Committee: Robert Kaufman (chair), Daniel Kelemen, Douglas Blair, Paul Poast (Chicago).
		\end{itemize}

  \item M.A. Political Science, Rutgers, The State University of New Jersey - New Brunswick, 2014.
...
\begin{itemize}
\item[$\bullet$] {\bf Referee/Reviewer}: Political Behavior.
