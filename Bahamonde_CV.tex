...
\begin{itemize}
  \item[\textcolor{gray}{\textbullet}] {\bf Jefe de Carrera}: Administraci\'on P\'ublica UOH, 2018.
  \item[\textcolor{gray}{\textbullet}] {\bf Investigador Asociado}: Observatorio Laboral UOH, 2020---today.
  \item[\textcolor{gray}{\textbullet}] {\bf Investigador Afiliado}: Instituto Milenio Fundamento de los Datos, 2020---today.
  \item[\textcolor{gray}{\textbullet}] {\bf Editorial Board Member}: journal ``\emph{Social Sciences},'' Springer Nature, 2020---today.
\end{itemize}
...
\begin{itemize}
\item[\textcolor{gray}{\textbullet}] Coordinator: \emph{Seminarios ICSO-UOH}, 2020---today.
