...
\begin{itemize}
  \item Ph.D. Political Science, Rutgers University (2017, expected).
  	\begin{itemize}
  		\item \texttt{Mayor}: \emph{\small comparative politics}, \texttt{Minor}: \emph{\small quantitative methods}.
	\end{itemize}
...
\begin{itemize}
\item Aiming Right At You: Group vs. Individual Clientelistic Targeting in Brazil, {\it Latin American Politics and Society}, forthcomming.
