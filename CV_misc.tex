...
{\bf Languages}: English, Spanish (native).


{\bf Software---advanced user}: \texttt{R}, \texttt{Stata}, \texttt{Python}, \LaTeX.

{\bf Certified Methods Proficiency}: Czech Summer School on Behavioral Economics 2026 (Behavioral Economics, Setting Up Experiments in oTree, Behavioral Public Policy, Neuroeconomics, etc.), Time Series I (ICPSR), Introduction to Bayesian Analysis (ICPSR), Time Series II (ICPSR), Advanced MLE - Panel Data (ICPSR), Experimental Political Science (RU), Advanced Research in Political Economy (RU), Formal Modeling I (Princeton), Advanced Econometrics (RU, Economics), Introduction to Game Theory (ICPSR), Regression III: Advanced Methods (ICPSR), Measurement, Scaling and Dimensional Analysis (ICPSR), Causal Inference for the Social Sciences (ICPSR), Regression Analysis (RU, Statistics), Maximum Likelihood Estimation for GLMs (RU).
