...
\title{Interview with the University of Turku}
...
\begin{itemize}
	\item {\bf Data and methods}: {\color{blue}List experiment} well suited to study behaviors subject to social desirability bias (such as selling one's vote) .
	\item N=1,479.
\end{itemize}
...
{\color{ForestGreen}{Original Survey Experiment}}:
\begin{itemize}
	\item {\bf Data and methods}: {\color{blue}List experiment} well suited to study behaviors subject to social desirability bias ({\color{red}such as selling one's vote}) .
	\item N=1,479.
\end{itemize}
...
\begin{itemize}
	\item Challenges the idea that only the poor are always targeted for clientelism.
		\begin{enumerate}
			\item {\scriptsize Wealthy individuals living in neighborhoods with lots of poor people are targeted too (Q1): {\bf they are more noticeable (i.e., accountable)!}}
			\item {\scriptsize Poor individuals living in neighborhoods with lots of poor people are targeted too only in context of high contestation (Q4).}
		\end{enumerate}
\end{itemize}
