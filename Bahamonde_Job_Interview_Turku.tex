...
\begin{itemize}
	\item Primary subfield is the political economy of {\bf inequality}, {\bf political development} and {\bf clientelism}. 
...
\miniframeson
\begin{frame}\frametitle{Pipeline 1: Clientelism and Democratic Theory}
...
\begin{enumerate}
	...
	\item {\color{ForestGreen}Finland has an outstanding educational system}: would be perfect for my 3YO and 4YO children! (EU citizens).
\end{enumerate}
\end{frame}
