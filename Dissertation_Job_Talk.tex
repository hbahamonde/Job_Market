...
\author{H\'ector Bahamonde $\bullet$ Political Science $\bullet$ Rutgers }
\date{May 31st 2017}
...
\begin{itemize}
	\item Introduction: Motivating the project
	\item Structure of the dissertation:
	
	\begin{itemize}
		\item[P1] \href{http://github.com/hbahamonde/IncomeTaxAdoption/raw/master/Bahamonde_IncomeTaxAdoption.pdf}{\input{/Users/hectorbahamonde/RU/Dissertation/Papers/IncomeTaxAdoption/title.txt}\unskip}
		
		\item[P2] \href{https://github.com/hbahamonde/Negative_Link_Paper/raw/master/Bahamonde_NegativeLink.pdf}{\input{/Users/hectorbahamonde/RU/Dissertation/Papers/NegativeLink/title.txt}\unskip}
		
		\item[P3] \href{https://github.com/hbahamonde/Earthquake_Paper/raw/master/Bahamonde_Earthquake_Paper.pdf}{\input{/Users/hectorbahamonde/RU/Dissertation/Papers/Earthquake_Paper/title.txt}\unskip}
	\end{itemize}

\item Structure of the presentation
	
	\begin{itemize}
		\item Motivation
		\item Theory/Argument
		\item Econometric tests
		\item[]
		\item Final overview
	\end{itemize}	
...
\item \underline{Also}: 
	...
	\begin{enumerate}
		\item Most theories emphasize how important fiscal capacities are for state-building. {\color{red}However}, these theories don't explain where these capacities come from.

		\item Political economists focus \emph{too much} on property rights when explaining economic development. {\color{red}Yet}, non-democratic regimes still produce economic growth.
...
\begin{frame}\frametitle{Argument}
	\begin{itemize}
		...
		\item[] Relying on the fiscal sociology paradigm, I contend that the implementation of the {\bf income tax} fostered {\bf state development}.
...
\begin{frame}\frametitle{Argument}
	\begin{itemize}
		...
		\begin{figure}[H]
		\vspace{0.15cm}\hspace{-8mm}\includegraphics[scale=0.6]{/Users/hectorbahamonde/RU/Dissertation/Papers/IncomeTaxAdoption/causal_path}
		\end{figure}
...
% Argentina
\begin{frame}[plain]
 \hspace{-1.1915cm}\includegraphics[scale=0.3]{/Users/hectorbahamonde/RU/Dissertation/Papers/IncomeTaxAdoption/Argentina_Income_Tax.pdf}
\end{frame}


% Chile
\begin{frame}[plain]
 \hspace{-1.1915cm}\includegraphics[scale=0.3]{/Users/hectorbahamonde/RU/Dissertation/Papers/IncomeTaxAdoption/Chile_Income_Tax.pdf}
\end{frame}


% Colombia
\begin{frame}[plain]
 \hspace{-1.1915cm}\includegraphics[scale=0.3]{/Users/hectorbahamonde/RU/Dissertation/Papers/IncomeTaxAdoption/Colombia_Income_Tax.pdf}
\end{frame}

% Ecuador
\begin{frame}[plain]
 \hspace{-1.1915cm}\includegraphics[scale=0.3]{/Users/hectorbahamonde/RU/Dissertation/Papers/IncomeTaxAdoption/Ecuador_Income_Tax.pdf}
\end{frame}

% Guatemala
\begin{frame}[plain]
 \hspace{-1.1915cm}\includegraphics[scale=0.3]{/Users/hectorbahamonde/RU/Dissertation/Papers/IncomeTaxAdoption/Guatemala_Income_Tax.pdf}
\end{frame}


% Mexico
\begin{frame}[plain]
 \hspace{-1.1915cm}\includegraphics[scale=0.3]{/Users/hectorbahamonde/RU/Dissertation/Papers/IncomeTaxAdoption/Mexico_Income_Tax.pdf}
\end{frame}


% Nicaragua
\begin{frame}[plain]
 \hspace{-1.1915cm}\includegraphics[scale=0.3]{/Users/hectorbahamonde/RU/Dissertation/Papers/IncomeTaxAdoption/Nicaragua_Income_Tax.pdf}
\end{frame}


% Peru
\begin{frame}[plain]
 \hspace{-1.1915cm}\includegraphics[scale=0.3]{/Users/hectorbahamonde/RU/Dissertation/Papers/IncomeTaxAdoption/Peru_Income_Tax.pdf}
\end{frame}


% Venezuela
\begin{frame}[plain]
 \hspace{-1.1915cm}\includegraphics[scale=0.3]{/Users/hectorbahamonde/RU/Dissertation/Papers/IncomeTaxAdoption/Venezuela_Income_Tax.pdf}
\end{frame}
...
\begin{frame}[plain, c]
\begin{center}
\Large \href{https://github.com/hbahamonde/Negative_Link_Paper/raw/master/Bahamonde_NegativeLink.pdf}{\input{/Users/hectorbahamonde/RU/Dissertation/Papers/NegativeLink/title.txt}\unskip}
\end{center}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item P1 explains that the emergence of the industrial sector \emph{accelerated} the implementation of the income tax law, a state-\emph{making} institution.

		\item Using the same theoretical apparatus:

			\begin{itemize}
				\item \emph{Ok, we now have the income tax. What happens to the economy?}

				\item P2 proposes that the implementation of the income tax set states in a path of long-term \emph{balanced} economic growth.
			\end{itemize}

	\end{itemize}

	\begin{exampleblock}{{\small Why is balanced {\bf economic} growth relevant for {\bf political} development?}} 
	Inter-sectoral balanced {\bf economic} growth \emph{leveled} both {\bf economic} sectors, preventing that any {\bf political elite} emerged as the leading group.
	\end{exampleblock}
...
\begin{frame}\frametitle{Argument}
	...
	\begin{itemize}
		\item[] When the {\bf implementation} of the income tax was product of {\bf credible sectoral threats},
	\end{itemize}

	\begin{figure}[H]
		%\vspace{-8mm}
		\includegraphics[width=1.05\textwidth]{/Users/hectorbahamonde/RU/Dissertation/Papers/NegativeLink/causal_path}
	\end{figure}
...
\begin{frame}\frametitle{Argument}
	...
	\begin{itemize}
		\item[] the {\bf political incorporation} of industrial elites {\bf broke} the foundations of the post-colonial institutional order, fostering long-term \emph{economic development}.
	\end{itemize}
...
\miniframeson
\begin{frame}\frametitle{{\Large Testing the Before/After Effect of the Income Tax on Economic Development}}
	
	\begin{itemize}
		\item[] Did changes in \emph{institutional order} replace economic backwardness institutions, causing long-term \emph{economic development}?
	\end{itemize}

	\begin{figure}[H]
		\vspace{-3.2mm}\includegraphics[width=1.08\textwidth]{/Users/hectorbahamonde/RU/Dissertation/Papers/NegativeLink/causal_path_2}
	\end{figure}
...
\begin{frame}\frametitle{`Ingredients'}
	...
	\begin{itemize}
		\item[Data] Same as before. \hyperlink{ts_plots}{\beamergotobutton{TS Plots}}

		\item[Model] Time-series techniques (Vector Autoregression, Granger causality tests \& Impulse Response Functions).
	\end{itemize}
...
\vspace{15mm}\hyperlink{unit_root}{\beamergotobutton{Unit root tests}} \hyperlink{lags_tests}{\beamergotobutton{Lag tests}} \hyperlink{johansen_tests}{\beamergotobutton{Cointegration Tests}}
\end{frame}
...
\begin{equation*}\label{var:1}
  \begin{array}{ll}
    \bigtriangleup {\color{red}M_{t_{m}}} = & \alpha_{m} + \beta_{m}  \bigtriangleup {\color{red}M_{t-L}} + \beta_{m} \bigtriangleup {\color{red}A_{t-L}} + \epsilon_{t_{m}} \\
    \\
    \bigtriangleup A_{t_{a}} = & \alpha_{a} + \beta_{a}  \bigtriangleup M_{t-L} + \beta_{a} \bigtriangleup A_{t-L} + \epsilon_{t_{a}}
  \end{array}
\end{equation*}
...
\begin{equation*}\label{var:1}
  \begin{array}{ll}
    \bigtriangleup M_{t_{m}} = & \alpha_{m} + \beta_{m}  \bigtriangleup M_{t-L} + \beta_{m} \bigtriangleup A_{t-L} + \epsilon_{t_{m}} \\
    \\
    \bigtriangleup {\color{red}A_{t_{a}}} = & \alpha_{a} + \beta_{a}  \bigtriangleup {\color{red}M_{t-L}} + \beta_{a} \bigtriangleup {\color{red}A_{t-L}} + \epsilon_{t_{a}}
  \end{array}
\end{equation*}
...
\begin{equation*}\label{var:1}
  \begin{array}{ll}
    \bigtriangleup {\color{blue}M_{t_{m}}} = & \alpha_{m} + \beta_{m}  \bigtriangleup {\color{red}M_{t-L}} + \beta_{m} \bigtriangleup {\color{red}A_{t-L}} + \epsilon_{t_{m}} \\
    \\
    \bigtriangleup {\color{blue}A_{t_{a}}} = & \alpha_{a} + \beta_{a}  \bigtriangleup {\color{red}M_{t-L}} + \beta_{a} \bigtriangleup {\color{red}A_{t-L}} + \epsilon_{t_{a}}
  \end{array}
\end{equation*}
...
\underline{Reversal of economic backwardness institutions}:



		\begin{itemize}
			\item[{\scriptsize {\color{black!30!green}Developed}}] {\bf Before implementing the tax}: {\color{red}industry} $\rightarrow$ {\color{red}agriculture}
			\item[{\scriptsize {\color{red}Underdev.}}] {\bf Before implementing the tax}: {\color{red}industry} $\rightarrow$ {\color{red}agriculture}
		\end{itemize}

\dotfill
		\begin{itemize}
			\item[{\scriptsize {\color{black!30!green}Developed}}] {\bf After implementing the tax}: {\color{black!30!green}agriculture} $\rightarrow$ {\color{black!30!green}industry}
			\item[{\scriptsize {\color{red}Underdev.}}] {\bf After implementing the tax}: {\color{red}industry} $\rightarrow$ {\color{red}agriculture}
		\end{itemize}
...
\miniframesoff
\begin{frame}\frametitle{Granger-Causality Tests}
...
\dotfill
		\begin{itemize}
			\item[{\scriptsize {\color{black!30!green}Developed}}] {\bf After implementing the tax}: {\Large{\bf{\color{black!30!green}agriculture}}} $\rightarrow$ {\Large{\bf{\color{black!30!green}industry}}}
			\item[{\scriptsize {\color{red}Underdev.}}] {\bf After implementing the tax}: {\color{red}industry} $\rightarrow$ {\color{red}agriculture}
		\end{itemize}

\vspace{7mm}	
{\color{black!30!green}Chile, Colombia, Argentina, Mexico} \hspace{3cm} \hyperlink{granger_test}{\beamergotobutton{Granger Tests}}
\end{frame}
...
\dotfill
		\begin{itemize}
			\item[{\scriptsize {\color{black!30!green}Developed}}] {\bf After implementing the tax}: {\color{black!30!green}agriculture} $\rightarrow$ {\color{black!30!green}industry}
			\item[{\scriptsize {\color{red}Underdev.}}] {\bf After implementing the tax}: {\Large{\bf{\color{red}industry}}} $\rightarrow$ {\Large{\bf{\color{red}agriculture}}}
		\end{itemize}

\vspace{7mm}	
{\color{red}Nicaragua \& Guatemala} \hspace{4.75cm} \hyperlink{granger_test}{\beamergotobutton{Granger Tests}}
\end{frame}


\miniframesoff
\begin{frame}\frametitle{Economic Growth in the Long Run}

	\begin{itemize}
		\item[] Using the same econometric apparatus (VAR), I computed impulse response functions (IRFs), and also found that this reversal (tested using Granger) {\bf persists} in the long-run.
	\end{itemize}
...
% Colombia
\begin{frame}[plain]
 \hspace{-1.16cm} \includegraphics[scale=0.85]{/Users/hectorbahamonde/RU/Dissertation/Papers/NegativeLink/Colombia_StructuralBreak.pdf}
\end{frame}


% Chile
\begin{frame}[plain]
 \hspace{-1.16cm} \includegraphics[scale=0.85]{/Users/hectorbahamonde/RU/Dissertation/Papers/NegativeLink/Chile_StructuralBreak.pdf}
\end{frame}
...
% Nicaragua
\begin{frame}[plain]
 \hspace{-1.16cm} \includegraphics[scale=0.85]{/Users/hectorbahamonde/RU/Dissertation/Papers/NegativeLink/Nicaragua_StructuralBreak.pdf}
\end{frame}


% Mexico
\begin{frame}[plain]
 \hspace{-1.16cm} \includegraphics[scale=0.85]{/Users/hectorbahamonde/RU/Dissertation/Papers/NegativeLink/Mexico_StructuralBreak.pdf}
\end{frame}
...
% Guatemala
\begin{frame}[plain]
 \hspace{-1.16cm} \includegraphics[scale=0.85]{/Users/hectorbahamonde/RU/Dissertation/Papers/NegativeLink/Guatemala_StructuralBreak.pdf}
\end{frame}


% Argentina
\begin{frame}[plain]
 \hspace{-1.16cm} \includegraphics[scale=0.85]{/Users/hectorbahamonde/RU/Dissertation/Papers/NegativeLink/Argentina_StructuralBreak.pdf}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item {\bf P1} and {\bf P2} {\bf theorize} that the income tax law was a state-\emph{making} institution. {\bf P3 provides support for these claims}. 

		\item Most {\bf theories} of state-building in comparative politics are historical. Yet, most {\bf measurements} capture \emph{contemporaneous} levels of state-capacities.

		\item I solve this deficit by providing a new measurement that captures {\bf actual outcomes of state efforts}: {\color{red}Earthquake death tolls}.
	\end{itemize}
...
\begin{frame}\frametitle{Thinking Subnationally}
	\begin{itemize}
		...
		\begin{figure}[H]
		\vspace{1cm}\hspace{-8mm}\includegraphics[scale=0.7]{/Users/hectorbahamonde/RU/Dissertation/Papers/Earthquake_Paper/causal_path}
		\end{figure}
...
\begin{frame}\frametitle{Argument}
	\begin{itemize}
		...
		\begin{figure}[H]
		\vspace{1.5cm}\hspace{-8mm}\includegraphics[scale=0.7]{/Users/hectorbahamonde/RU/Dissertation/Papers/Earthquake_Paper/causal_path}
		\end{figure}
...
\begin{frame}\frametitle{Argument}
	\begin{itemize}
		...
		\item[] \scalerel*{\includegraphics{/Users/hectorbahamonde/RU/Dissertation/Presentation/Resources/chilean-flag-large}}{B} Chilean industrial elites accepted to be income taxed while demanding (1) access to the state and (2) infrastructure beneficial for industrial sector at the subnational level.




		\begin{figure}[H]
		\vspace{6mm}\hspace{-8mm}\includegraphics[scale=0.7]{/Users/hectorbahamonde/RU/Dissertation/Papers/Earthquake_Paper/causal_path}
		\end{figure}
