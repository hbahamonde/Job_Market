...
\begin{frame}
	\begin{itemize}
		\item The first section helps us to understand \emph{when} countries implement the income tax, and \emph{why} `when' is relevant.\pause\; However, it doesn't link income taxation with state capacities.\pause\; Historians and fiscal sociologists provide some answers, but this relationship in Latin American political economy has been overlooked.\pause\; \emph{{\bf Did the expansion of the fiscal system improve state capacities overtime in Latin America?}}\pause
