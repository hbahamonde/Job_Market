...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\\
		{\bf {\color{red}Status}}: {\input{/Users/hectorbahamonde/RU/Dissertation/Papers/IncomeTaxAdoption/status.txt}\unskip}.
...
\begin{frame}[plain, c]
\begin{center}
\huge{1. What are the {\bf origins} of the tax state in Latin America?}\pause
\\
\vspace{2cm}
...
\begin{frame}[plain, c]
\begin{center}
\huge{2. How can we {\bf measure the effects} of fiscal expansion on state capacities overtime?}\pause
\\
\vspace{2cm}
...
\begin{frame}\frametitle{Argument}
	\begin{itemize}
		...
		\item[{\color{red}$\star$}] {\color{red}Relying} on the fiscal sociology paradigm, I contend that the implementation of the {\bf income tax} fostered {\bf state-building}.
