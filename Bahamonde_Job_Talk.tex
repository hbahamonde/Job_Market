...
\title{{\input{/Users/hectorbahamonde/Dissertation/Dissertation/title.txt}\unskip}}
...
\begin{itemize}
	...
	\begin{enumerate}
		...
		\item \href{http://github.com/hbahamonde/IncomeTaxAdoption/raw/master/Bahamonde_IncomeTaxAdoption.pdf}{\input{/Users/hectorbahamonde/Dissertation/Papers/IncomeTaxAdoption/title.txt}\unskip}.
		\\
		{\bf {\color{red}Status}}: {\input{/Users/hectorbahamonde/Dissertation/Papers/IncomeTaxAdoption/status.txt}\unskip}.\pause

\vspace{5mm}

		\item \href{https://github.com/hbahamonde/Earthquake_Paper/raw/master/Bahamonde_Earthquake_Paper.pdf}{\input{/Users/hectorbahamonde/Dissertation/Papers/Earthquake_Paper/title.txt}\unskip}.
		\\
		{\bf {\color{red}Status}}: {\input{/Users/hectorbahamonde/Dissertation/Papers/Earthquake_Paper/status.txt}\unskip}.
...
\begin{frame}\frametitle{Earthquake and States Capacities}
	...
	\column{0.5\textwidth}
		...
		\hspace{-5mm}\frame{\includegraphics[scale=0.27]{/Users/hectorbahamonde/Dissertation/Papers/Earthquake_Paper/Resources/haiti_quake}}
		\end{figure}
	...
	\column{0.5\textwidth}
		...
		\hspace{-7mm}\frame{\includegraphics[scale=0.2]{/Users/hectorbahamonde/Dissertation/Papers/Earthquake_Paper/Resources/alto_rio_quake}}
		\end{figure}
...
\vspace{-0.7cm}
	...
	\column{0.5\textwidth}
		...
		\begin{figure}[H]
		\vspace{1mm}\frame{\includegraphics[scale=0.2]{/Users/hectorbahamonde/Dissertation/Papers/Earthquake_Paper/Resources/nyt_quake}}
		\end{figure}


		\begin{figure}[H]
		\vspace{1mm}\frame{\includegraphics[scale=0.2]{/Users/hectorbahamonde/Dissertation/Papers/Earthquake_Paper/Resources/mexico_nyt}}
		\end{figure}

	\column{0.5\textwidth}
		
		\begin{figure}[H]
		\vspace{15mm}\hspace{-30mm}\frame{\includegraphics[scale=0.19]{/Users/hectorbahamonde/Dissertation/Papers/Earthquake_Paper/Resources/cnn_quake}}
		\end{figure}
...
\vspace{-0.7cm}
	...
	\column{0.5\textwidth}
		...
		\begin{figure}[H]
		\vspace{1mm}\frame{\includegraphics[scale=0.2,cfbox=red 2pt]{/Users/hectorbahamonde/Dissertation/Papers/Earthquake_Paper/Resources/mexico_nyt}}
		\end{figure}
...
\begin{frame}[plain, c]
\begin{center}
\Large \href{http://github.com/hbahamonde/IncomeTaxAdoption/raw/master/Bahamonde_IncomeTaxAdoption.pdf}{\input{/Users/hectorbahamonde/Dissertation/Papers/IncomeTaxAdoption/title.txt}\unskip}
\end{center}
\end{frame}
\miniframeson
...
\begin{frame}\frametitle{Argument}
	\begin{itemize}
		...
		\begin{figure}[H]
		\frame{\includegraphics[scale=13.5]{/Users/hectorbahamonde/Dissertation/Presentation/Resources/Baile_del_Santiago_antiguo}}\caption*{{\tiny `Baile del Santiago Antiguo.' Pedro Subercaseaux Err\'azuriz (1917).}}
		\label{fig:baile}
		\end{figure}
...
\begin{frame}\frametitle{Argument}
	\begin{itemize}
		...
		\hspace{-9.2mm}
		%\centering
		\includegraphics[scale=0.6]{/Users/hectorbahamonde/Job_Market/causal_path_p1_strong}
		\end{figure}
...
\begin{frame}\frametitle{Argument}
	\begin{itemize}
		...
		\begin{figure}[H]
		\vspace{1cm}\hspace{-8mm}\includegraphics[scale=0.6]{/Users/hectorbahamonde/Job_Market/causal_path_p1_strong}
		\end{figure}
...
\begin{frame}\frametitle{Argument}
	\begin{itemize}
		...
		\begin{figure}[H]
		\vspace{0.6cm}\hspace{-8mm}\includegraphics[scale=0.6]{/Users/hectorbahamonde/Job_Market/causal_path_p1_strong}
		\end{figure}
...
\begin{frame}\frametitle{Argument}
	\begin{itemize}
		...
		\item[] \scalerel*{\includegraphics{/Users/hectorbahamonde/Dissertation/Presentation/Resources/chilean-flag-large}}{B} I find that Chilean industrial elites accepted to be income taxed, while demanding political incorporation, and public infrastructure beneficial for industrial production.

		\begin{figure}[H]
		\vspace{.52cm}\hspace{-8mm}\includegraphics[scale=0.6]{/Users/hectorbahamonde/Job_Market/causal_path_p1_strong}
		\end{figure}
...
\begin{frame}\frametitle{Argument}
	\begin{itemize}
		...
		\item[] \scalerel*{\includegraphics{/Users/hectorbahamonde/Dissertation/Presentation/Resources/chilean-flag-large}}{B} As industrialists depended more on infrastructure implemented at the local level (roads, railroads and bridges), they preferred to shoulder a higher tax burden through progressive direct taxation.
...
\begin{frame}\frametitle{Argument}
	\begin{itemize}
		...
		\begin{figure}[H]
		\vspace{0.5cm}\hspace{-8mm}\includegraphics[scale=0.6]{/Users/hectorbahamonde/Job_Market/causal_path_p1_failed}
		\end{figure}
...
% Argentina
\begin{frame}[plain]
 \includegraphics[scale=0.35]{/Users/hectorbahamonde/Dissertation/Papers/IncomeTaxAdoption/Argentina_Income_Tax.pdf}
\end{frame}


% Chile
\begin{frame}[plain]
 \includegraphics[scale=0.35]{/Users/hectorbahamonde/Dissertation/Papers/IncomeTaxAdoption/Chile_Income_Tax.pdf}
\end{frame}


% Colombia
\begin{frame}[plain]
 \includegraphics[scale=0.35]{/Users/hectorbahamonde/Dissertation/Papers/IncomeTaxAdoption/Colombia_Income_Tax.pdf}
\end{frame}

% Ecuador
\begin{frame}[plain]
 \includegraphics[scale=0.35]{/Users/hectorbahamonde/Dissertation/Papers/IncomeTaxAdoption/Ecuador_Income_Tax.pdf}
\end{frame}

% Guatemala
\begin{frame}[plain]
 \includegraphics[scale=0.35]{/Users/hectorbahamonde/Dissertation/Papers/IncomeTaxAdoption/Guatemala_Income_Tax.pdf}
\end{frame}


% Mexico
\begin{frame}[plain]
 \includegraphics[scale=0.35]{/Users/hectorbahamonde/Dissertation/Papers/IncomeTaxAdoption/Mexico_Income_Tax.pdf}
\end{frame}


% Nicaragua
\begin{frame}[plain]
 \includegraphics[scale=0.35]{/Users/hectorbahamonde/Dissertation/Papers/IncomeTaxAdoption/Nicaragua_Income_Tax.pdf}
\end{frame}


% Peru
\begin{frame}[plain]
 \includegraphics[scale=0.35]{/Users/hectorbahamonde/Dissertation/Papers/IncomeTaxAdoption/Peru_Income_Tax.pdf}
\end{frame}


% Venezuela
\begin{frame}[plain]
 \includegraphics[scale=0.35]{/Users/hectorbahamonde/Dissertation/Papers/IncomeTaxAdoption/Venezuela_Income_Tax.pdf}
\end{frame}
...
\end{itemize}
	...
	\begin{figure}[H]
	\hspace{-17mm}
	\includegraphics[width=1.0\textwidth]{/Users/hectorbahamonde/Dissertation/Presentation/Resources/simulation:plots-1.pdf}
	\end{figure}
...
\begin{frame}[plain, c]
\begin{center}
\Large \href{https://github.com/hbahamonde/Earthquake_Paper/raw/master/Bahamonde_Earthquake_Paper.pdf}{\input{/Users/hectorbahamonde/Dissertation/Papers/Earthquake_Paper/title.txt}\unskip}
\end{center}
\end{frame}
\miniframeson
...
\end{itemize}
	...
	\vspace{-0.2cm}
		...
		\begin{figure}[H]
		\hspace{-7mm}\frame{\includegraphics[scale=0.33]{/Users/hectorbahamonde/Dissertation/Presentation/Resources/quake_map.jpg}}
		\end{figure}
...
%		\frame{\includegraphics[scale=0.39]{/Users/hectorbahamonde/Dissertation/Presentation/Resources/Montt_quake}}
%		\end{figure}
%	
%
%\end{frame}
...
\begin{frame}\frametitle{Thinking Subnationally}
	\begin{itemize}
		...
		\begin{figure}[H]
		%\vspace{0.3cm}
		\hspace{-8mm}\includegraphics[scale=0.7]{/Users/hectorbahamonde/Dissertation/Papers/Earthquake_Paper/causal_path}
		\end{figure}
...
\begin{frame}\frametitle{Argument}
	\begin{itemize}
		...
		\begin{figure}[H]
		\vspace{5mm}\hspace{-8mm}\includegraphics[scale=0.7]{/Users/hectorbahamonde/Dissertation/Papers/Earthquake_Paper/causal_path}
		\end{figure}
...
\begin{frame}[plain]%\frametitle{Analyses}
		...
		\begin{figure}[H]
		\vspace{4mm}
		\hspace{-7.5mm}\includegraphics[scale=0.7]{/Users/hectorbahamonde/Dissertation/Papers/Earthquake_Paper/figure/earthquake:ts:plot:chile-1.pdf}
		\end{figure}
...
\begin{frame}[plain]%\frametitle{Analyses}
		...
		\vspace{-5mm}
		%\hspace{-10mm}
		\includegraphics[scale=0.27]{/Users/hectorbahamonde/Dissertation/Papers/Earthquake_Paper/Resources/chile_quake_map.jpeg}
		\end{figure}
...
\begin{frame}\frametitle{{\large Estimating Effects of Subnational Contestation on Death Tolls}}
 %\hspace{-1.16cm}
 \centering\includegraphics[scale=0.75]{/Users/hectorbahamonde/Dissertation/Papers/Earthquake_Paper/figure/sectoral:model:plot:run-1.pdf}
\end{frame}
...
\begin{frame}\frametitle{{\large Estimating Effects of Income Taxation on Death Tolls Overtime}}
 %\hspace{-1.16cm}
  \centering\includegraphics[scale=0.75]{/Users/hectorbahamonde/Dissertation/Papers/Earthquake_Paper/figure/income:tax:model:plot:run-1.pdf}
\end{frame}
...
\end{itemize}
	...
	\begin{figure}[H]
	%\hspace{-17mm}
	\centering\includegraphics[width=1.0\textwidth]{/Users/hectorbahamonde/Dissertation/Presentation/Resources/simulation:plots-1.pdf}
	\end{figure}
\end{frame}
...
\end{itemize}
	...
	\begin{figure}[H]
	\vspace{-5mm}
	\centering\includegraphics[scale=0.4]{/Users/hectorbahamonde/Dissertation/Papers/NegativeLink/Chile_StructuralBreak.pdf}	
	\end{figure}
...
\begin{frame}[label = why_not_indirect_taxes]\frametitle{Why {\color{red}Not \emph{In}}direct Taxation}
	...
	\column{0.6\textwidth}
		\begin{figure}[H]
		\frame{\includegraphics[scale=0.22]{/Users/hectorbahamonde/Dissertation/Presentation/Resources/Talcahuano}}\caption*{{\tiny Talcahuano Port, Chile 19th Century.}}
...
\begin{frame}[label=death_count_plot]
 %\hspace{-1.16cm} 
 \centering\includegraphics[scale=0.8]{/Users/hectorbahamonde/Dissertation/Presentation/Resources/count_plot.pdf}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}[label=ts_plots]
 %\hspace{-1.16cm} 
 \centering\includegraphics[scale=0.75]{/Users/hectorbahamonde/Dissertation/Papers/NegativeLink/Structural_Breaks_Paper.pdf}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}[label=density_plot_sectoral]
 \centering\includegraphics[scale=0.3]{/Users/hectorbahamonde/Dissertation/Papers/Earthquake_Paper/figure/denplot:plot:sectoral-1.pdf}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\hspace{-1.16cm} 
\centering\includegraphics[scale=0.3]{/Users/hectorbahamonde/Dissertation/Papers/Earthquake_Paper/figure/traplot:plot:sectoral-1}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\hspace{-1.16cm} 
\centering\includegraphics[scale=0.3]{/Users/hectorbahamonde/Dissertation/Papers/Earthquake_Paper/figure/predicted:observed:plot-1}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\hspace{-1.16cm} 
\centering\includegraphics[scale=0.7]{/Users/hectorbahamonde/Dissertation/Papers/Earthquake_Paper/figure/incometax-1}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}[label=density_plot_tax]
 \centering\includegraphics[scale=0.35]{/Users/hectorbahamonde/Dissertation/Papers/Earthquake_Paper/figure/denplot:plot:tax-1.pdf}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%\hspace{-1.16cm} 
\centering\includegraphics[scale=0.35]{/Users/hectorbahamonde/Dissertation/Papers/Earthquake_Paper/figure/traplot:plot:tax-1}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
