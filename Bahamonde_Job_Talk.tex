...
\begin{frame}\frametitle{Dual Political Economy}
	...
	\begin{itemize}
		...
		\item Hence, agricultural expansion is a self-undermining process \tiny{(relative to industrial expansion),}\normalsize\; and ``cultivates the seeds of its own demise.''

		\item I {\bf {\color{red}extrapolate} this conflict to their respective {\color{red}sectoral preferences towards income taxation}}---and consequently---{\bf state centralization}.
	\end{itemize}
...
\begin{frame}\frametitle{Dual Political Economy}
	...
	\begin{itemize}
		...
		\item I find in the next section that industrialists preferred to impose an income tax on themselves.\pause\; Given their higher dependence on imports (capital), imposing an import tax would have made them worse off.
	\end{itemize}
...
\begin{frame}\frametitle{Argument}
	\begin{itemize}
		...
		\item[] State presence became more dense and complex, fostering state-making. Income {\bf taxation} was the main {\color{red}{\bf engine}} that promoted {\bf state-building}.
...
\begin{frame}
	\begin{itemize}
		...
		\item[\tiny{Mechanism}] Beyond `\emph{War makes states and states make war}.'  
...
\begin{frame}\frametitle{Argument}
	\begin{itemize}
		...
		\item[] \underline{{\bf Conceptualizing contestation}}: {\bf regional industrial expansion} contesting {\bf agricultural national} economic hegemony.
