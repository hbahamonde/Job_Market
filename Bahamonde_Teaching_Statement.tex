...
% Date
\vspace{5mm}\today\\
Download last version \href{http://github.com/hbahamonde/Job_Market/raw/master/Bahamonde_Teaching_Statement.pdf}{\texttt{here}}}} % Link to last version


{\huge\vspace{8mm} Teaching Statement}
\end{center} 

\signature{\vspace{1cm}h.b., fall 2016} % Your name for the signature at the bottom
...
% teaching: applied / data
%I firmly believe that an excellent complement to substantive knowledge is the ``practice'' of being a comparativist. One course I have always wanted to teach at the graduate level is a ``practicum'' in comparative politics (certainly easily extendable to IR and students of American politics too). This course should be designed to be a space for advanced graduate students to work on their own projects using interesting quantitative methods. Rather than having individual meetings with the students, the course should be designed to put students in the ``driving sit'' to let them work on their own papers/chapters. One possible design is to split the semester in two halves. The first half should provide the methodological fundamentals paired with practical/substantive examples. At this stage, I provide the datasets and the substantive applications. Topics can vary, but preliminary topics could be economic development, electoral institutions, analysis of survey data and issues in causal inference (instrumental variables, matching, DID and regression discontinuity designs). Depending on the demand, other topics not from comparative politics should be included too. The second half consists of both preliminary presentations and final student presentations. In these two instances, students serve both as presenters and discussants. 

% list courses
%All and all, as an assistant professor I would like to teach courses on comparative politics (general course), political regimes and regime change, political economy of development, economic history and political economy, changes in Latin America, applied quantitative methods in political science, research design and introduction to quantitative methods in political science.
...
\item Substantive Courses:
	...
	\item Political Economy of Development (UG \href{https://github.com/hbahamonde/Political-Economy-Intro-UGrad/raw/master/Pol_Econ_Dev_Syllabus_UGRAD.pdf}{syllabus}  / G \href{https://github.com/hbahamonde/Pol_Econ_Dev_Grad/raw/master/Pol_Econ_Dev_Syllabus_GRAD.pdf}{syllabus}).
