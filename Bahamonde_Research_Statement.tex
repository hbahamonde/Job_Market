...
The second experiment is a {\bf conjoint experiment} and it is being analyzed in a separate \href{https://github.com/hbahamonde/Conjoint_US/raw/master/Bahamonde_Quininao_Conjoint.pdf}{\texttt{paper}} (``\input{/Users/hectorbahamonde/research/Conjoint_US/title.txt}\unskip,\unskip'' \emph{\input{/Users/hectorbahamonde/research/Conjoint_US/status.txt}\unskip}). My coauthor and myself are developing a new methodology to analyzing conjoint experiments via {\bf machine learning} techniques, particularly, {\bf support vector machines}. 

Finally, and within the same project, I am currently designing an {\bf economic experiment} in the lab. \input{/Users/hectorbahamonde/research/Economic_Experiment_Vote_Selling/abstract.txt}\unskip
