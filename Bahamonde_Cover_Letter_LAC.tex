...
Additionally, I am currently building on the findings of a series of {\bf working papers related to vote-buying and vote-selling}, using both observational and an original experimental dataset in the Americas. One of these papers discusses why parties target in a clientelistic way groups \emph{or} individuals. You can download the latest version of the later (which is \emph{\input{/Users/hectorbahamonde/RU/research/Clientelism_paper/status.txt}\unskip}) \href{https://github.com/hbahamonde/Clientelism_paper/raw/master/Bahamonde_Clientelism_Paper.pdf}{\texttt{here}}. 
